...
import { View, Text, ImageBackground, StyleSheet, TextInput, Image, TouchableOpacity, FlatList } from 'react-native';
  ...
  return (
    <View style={styles.flex1}>
      ...
      <Link
        ...
        // onPress={() => router.push('/event/qr-scanner')}
        href="/event/qr-scanner"
      >
